...
1. **Reconnect** to your deploy instance via SSM (`io106-<your_id>-deploy`, same box as Lab 0). From `~/io-106/lab_environment/lab_env_student/`, confirm your baseline is still healthy before you break it:
